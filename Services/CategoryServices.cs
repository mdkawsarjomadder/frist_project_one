...
using frist_project_one.Interface;
        ...
        */
        ...
        var FormatSerach = $"%{(search != null ? search.Trim() : "")}%";
                ...
                {
                query = sortOrderParse switch
                {
                        SortOrderName.NameAsc   => query.OrderBy(c => c.Name),
                        SortOrderName.NameDesc  => query.OrderByDescending(c => c.Name),
                        SortOrderName.CreateAtAsc => query.OrderBy(c => c.CategoryAt),
                        SortOrderName.CreateAtDesc=> query.OrderByDescending(c => c.CategoryAt),
...
/*   
                ...
                //   {
                //                 var formatSorting = SortOrder.Trim().ToLower();
                //                 query = formatSorting switch

                //                 {
                //                         "name_asc"  => query.OrderBy(c => c.Name),
                //                         "name_desc"  => query.OrderByDescending(c => c.Name),
                //                         "create_asc" => query.OrderBy(c => c.Name),
                //                         "create_desc" => query.OrderByDescending(c => c.Name),_ => query.OrderBy(c => c.Name) //Default sorting.!
                ...
                case "create_asc":
                query = query.OrderBy(c => c.CategoryAt);
                break;
                case "createdat_desc":
                query = query.OrderByDescending(c => c.CategoryAt);
                break;
                default:
                query = query.OrderBy(c => c.Name);
                break;
